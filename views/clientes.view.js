            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4">
                        <a href="/clientes/modificar/${cliente._id}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 text-center">Modificar</a>
                        <a href="/clientes/eliminar/${cliente._id}" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 text-center">Eliminar</a>
                        <a href="/clientes/cursos/nuevo?clienteId=${cliente._id}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 text-center">Agregar Curso</a>
                        <a href="/clientes/cursos?clienteId=${cliente._id}" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600 text-center">Ver Cursos</a>
                    </div>
...
export function crearCursoNuevo(cliente){
    let html = `
    <a href="/clientes" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 ms-6 mt-6 ">
    Volver a clientes
    </a>
...
export function crearCursos(cursos, clienteId) {
    ...
    <div class="flex justify-between items-center mt-6 mx-4">
        ...
        <a href="/clientes" type="button" class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 ms-4 ">
            Volver a clientes
        </a>
    </div>
